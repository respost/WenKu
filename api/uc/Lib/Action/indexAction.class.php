...
class indexAction extends Action {
    ...
    public function _initialize() {
    	...
    	include_once MTCEO_PATH .'app/Lib/Model/globalModel.class.php';
        ...
        include_once MTCEO_PATH .'app/Lib/Model/userModel.class.php';
     ...
     * 
     */
   public function getcreditsettings() {//传递mtceo的积分设置给其他应用，便于ucenter设置兑换方案
   	
   

   	$credits = array(
        '1' => array(C('mtceo_score_name'), ''),
       );
